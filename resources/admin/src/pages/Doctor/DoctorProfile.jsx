  ...
  const updateProfile = async () => {
    try {
      const updateData = {
        ...
        consultation_fee: profileData.fees,
        is_approved:      profileData.available ? 1 : 0,
      }
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white '>
          ...
          <div className='flex gap-2 py-2'>
            ...
            <p className='text-sm'>
              {isEdit
                ? <input type="text" value={profileData.address?.line1 || ''} onChange={(e) => setProfileData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} />
